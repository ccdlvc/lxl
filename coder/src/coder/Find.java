               ...
               java.lang.Iterable<java.io.File>
{
     ...
     * @name dir Directory
     * @exception java.lang.IllegalStateException Directory not found
     */
        ...
        throws java.lang.IllegalStateException
    {
        ...
        if (this.dir.isDirectory()){
            ...
            throw new java.lang.IllegalStateException("Directory not found '"+dir+"'.");
    }
    ...
    public static void main(String[] argv){
        ...
        Find list = new Find(new java.io.File(argv[0]));
